	...
	,	getContext: function ()
		{
			...
			jQuery.ajax({
						...
						success: function ( res ){ 
							...
							{
								hasCollectorProfile = true;
							}else
							{
								hasCollectorProfile = false;
							}
						}
					});

			console.log(hasCollectorProfile)
			...
			,   hasCollectorProfile: hasCollectorProfile
