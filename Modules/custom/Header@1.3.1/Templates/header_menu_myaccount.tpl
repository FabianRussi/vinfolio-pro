...
<ul class="header-menu-myaccount">
	...
	<li class="header-menu-myaccount-item-level2">
		...
		<ul class="header-menu-myaccount-level3">
			...
			<li>
				<a class="header-menu-myaccount-anchor-level3" href="#" data-touchpoint="customercenter" data-hashtag="#collectorprofile" name="collectorprofile">
					{{translate 'Collector Profile'}}
				</a>
			</li>
			<li>
				<a class="header-menu-myaccount-anchor-level3" href="#" data-touchpoint="customercenter" data-hashtag="#invite" name="invite">
					{{translate 'Get 10%'}}
				</a>
			</li>
		</ul>
