		...
		<div class="order-wizard-showshipments-module-shipping-details-body">
			...
			<div class="order-wizard-showshipments-module-shipping-details-address">
							...
							{{#if showSelectedShipmethod}}
								...
								<div class="order-wizard-showshipments-module-shipping-details-method-info-card">
									...
									<span class="order-wizard-showshipments-module-shipmethod-rate">
										{{#ifEquals selectedShipmethod.rate_formatted "Free!"}}
											{{translate 'Charged at the time of shipping'}}
										{{else}}
				...
				{{#if expectedDeliveryDate}}
					<h4 class="order-wizard-shipmethod-module-webship-date-label">{{translate 'Expected Delivery Date'}}</h4>
					<input type="text" readonly class="order-wizard-shipmethod-module-webship-date" id="expected_delivery_date" name="expected_delivery_date" data-format="mm/dd/yyyy" value="{{expectedDeliveryDate}}">
				{{/if}}
			</div>
