	...
	)
{
	...
	,	getContext: function ()
		{
			var self = this
			,	show_shipmethod = false
			,	show_edit_button = !!this.options.edit_url
			,	shipping_type = this.wizard.model.get('options').custbody_vf_shippingtypeonso
			...
			console.log(this.model.get('shipmethod'))
			...
			return {
				...
				,	showEditButton: show_edit_button // !!this.options.edit_url
					//@property {Boolean}
				...
				,	shippingAddress: !!address_source && address_source.get('fullname')
					//@property {Boolean} showShipmethod 
				,	showShipmethod: show_shipmethod
					//@property {String} expectedDeliveryDate
				,	expectedDeliveryDate: (sessionStorage.getItem("expected_delivery_date")) ? sessionStorage.getItem("expected_delivery_date") : ''
