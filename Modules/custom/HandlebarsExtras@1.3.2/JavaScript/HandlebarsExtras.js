	...
	)
{
	...
	Handlebars.registerHelper('translate', function ()
	{
		...
		if((!arguments[1] && arguments[1]!=0) || !arguments[2] || !arguments[3] || !arguments[4]){
			 arguments[0] = arguments[0].replace("</span> - <span","</span><span")
		   }
	...
	//Helper 'ifEqualsOr' works like if (v1 == v2 || v1 == v3) {} else {}
