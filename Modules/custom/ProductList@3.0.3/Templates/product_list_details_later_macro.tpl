...
<article class="product-list-details-later-macro-selectable-actionable" data-id="{{model.internalid}}" data-item-id="{{itemId}}">
	<div>
		...
		<div class="product-list-details-later-macro-details">
			...
			<div class="product-list-details-later-macro-qty hide">
			...
			<div class="product-list-details-later-macro-actions align-row" data-type="item-commands">
				{{#if showActions}}
				
				<button class="product-list-details-later-macro-button-remove" data-action="delete-item">
					{{translate 'Remove'}}</button>
				<button data-action="add-to-cart" class="product-list-details-later-macro-button-remove ml-1 {{#unless canBeAddedToCart}}disabled{{/unless}}" {{#unless canBeAddedToCart}}disabled{{/unless}}>
