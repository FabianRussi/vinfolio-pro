...
{{#if hasFacetsOrAppliedFacets}}
	<h3 class="facets-faceted-navigation-title" style="display: none;">{{translate 'Narrow By'}}</h3>
	...
	<div data-view="Facets.FacetedNavigationItems" class="faceted-navigation-items"></div>
