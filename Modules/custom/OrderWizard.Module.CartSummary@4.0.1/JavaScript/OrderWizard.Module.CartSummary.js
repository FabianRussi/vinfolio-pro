	...
	,	getContext: function getContext ()
		{
			...
			//console.log($.cookie('floodlighttrackernewuser'))

			var floodlightCookie = $.cookie('floodlighttrackernewuser');

			/*var profile = ProfileModel.getInstance()
			,   pFirstname = profile.get('firstname')
			,   pLastname = profile.get('lastname')
			...
			return {
				...
				, floodlightCookie: floodlightCookie
