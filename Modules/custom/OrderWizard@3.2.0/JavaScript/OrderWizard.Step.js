	...
	,	getContext: function ()
		{
			...
			return {
					...
					showTitle: !!(this.getName() !== 'Choose Shipping Address')	
				...
				,	bottomMessageClass: _.isFunction(this.bottomMessageClass) ? this.bottomMessageClass() : this.bottomMessageClass || ''
					//@property {Boolean} shippingFlag
				,	shippingFlag:((this.options.wizard.model.attributes.options.custbody_vf_shippingtypeonso == 3) && (this.hideBackButton || this.wizard.isCurrentStepFirst()) && this.options.wizard.model.attributes.addresses.length != 0) ? true : false
					//@property {Boolean} disableContinue
				,	disableContinue: (this.options.wizard.model.attributes.addresses.length == 0 && (this.hideBackButton || this.wizard.isCurrentStepFirst())) ? true :false
					//@property {Boolean} continueStyles
				,	continueStyles: (this.options.wizard.model.attributes.options.custbody_vf_shippingtypeonso == 1) ? true : false
