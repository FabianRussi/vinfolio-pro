...
<div class="cart-detailed">
	...
	<div class="cart-detailed-body">
		<section class="{{#if showLines}}cart-detailed-left {{else}}cart-detailed-empty{{/if}}">
			...
			<div class="row cart-detail-heading-main">
			<div class="col-md-4">ITEM ({{productsAndItemsCount}})</div>
			<div class="col-md-2"></div>
			<div class="col-md-2"></div>
			<div class="col-md-2 price-text-right" >UNIT PRICE</div>
			<div class="col-md-2 price-text-right">SUB TOTAL</div>
			  </div>
