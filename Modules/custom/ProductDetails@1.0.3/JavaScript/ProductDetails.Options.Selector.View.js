			...
			,	'Options.Collection': function ()
				{
					...
					,	childViewOptions: {
						...
						,	default_custcol11_option: this.options.default_custcol11_option
						,	default_custcol8_option: this.options.default_custcol8_option
						,   origin : this.options.origin
						,   available_sizes: this.options.available_sizes
				 	    ,   unavailable_sizes: this.options.unavailable_sizes
						}
					});
				}
			,	'Item.Price': function ()
