	...
	)
{
	...
	,	errors: ['ERR_CHK_INCOMPLETE_ADDRESS', 'ERR_CHK_SELECT_SHIPPING_ADDRESS', 'ERR_CHK_INVALID_SHIPPING_ADDRESS', 'ERR_WS_INVALID_SHIPPING_ADDRESS', 'ERR_CHK_SELECT_SHIPPING_TYPE']
	...
	,	selectShippingTypeErrorMessage: {
			errorCode: 'ERR_CHK_SELECT_SHIPPING_TYPE'
		,	errorMessage: _('Please select a shipping type').translate()
		}
