define('cart_detailed.tpl', ['Handlebars','Handlebars.CompilerNameLookup'], function (Handlebars, compilerNameLookup){ var template = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return " <div class=\"cart-detailed-proceed-to-checkout-container\"><a class=\"cart-detailed-proceed-to-checkout\" data-action=\"sticky\" href=\"#\" data-touchpoint=\"checkout\" data-hashtag=\"#\"> "
    ...
    + " </a></div><div data-confirm-message class=\"cart-detailed-confirm-message\"></div><div data-view=\"Promocode.Notifications\"></div><div class=\"row cart-detail-heading-main\"><div class=\"col-md-4\">ITEM ("
    + alias3(((helper = (helper = compilerNameLookup(helpers,"productsAndItemsCount") || (depth0 != null ? compilerNameLookup(depth0,"productsAndItemsCount") : depth0)) != null ? helper : alias2),(typeof helper === "function" ? helper.call(alias1,{"name":"productsAndItemsCount","hash":{},"data":data}) : helper)))
    + ")</div><div class=\"col-md-2\"></div><div class=\"col-md-2\"></div><div class=\"col-md-2 price-text-right\" >UNIT PRICE</div><div class=\"col-md-2 price-text-right\">SUB TOTAL</div></div><table class=\"cart-detailed-item-view-cell-actionable-table cart-detailed-table-row-with-border\"><tbody data-view=\"Item.ListNavigable\"></tbody></table> ";
  ...
  return " <div class=\"cart-detailed\"><div class=\"cart-detailed-view-header\"><header class=\"cart-detailed-header\"> "
    ...
    + " <div data-view=\"Quick.Order\" style=\"display: none;\"></div> "
    ...
    + " </div></div><script> jQuery(document).ready(function(){\n	jQuery(\".global-views-breadcrumb\").hide();\n	jQuery(\".cart-summary-expander-container\").hide();\n}); </script>  ";
