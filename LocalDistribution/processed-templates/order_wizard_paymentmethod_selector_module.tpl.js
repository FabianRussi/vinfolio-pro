define('order_wizard_paymentmethod_selector_module.tpl', ['Handlebars','Handlebars.CompilerNameLookup'], function (Handlebars, compilerNameLookup){ var template = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
    var helper;
  ...
  return " <div class=\"order-wizard-paymentmethod-selector-module\"> "
    ...
    + " <div class=\"order-wizard-paymentmethod-selector-module-payment-method-selector-content\" id=\"payment-method-selector-content\"></div></div><script> jQuery(document).ready(function () {\n	// Hide 'Shipping Type' view only\n	jQuery('.order-wizard-address-module-shipping-type').hide();\n	jQuery('.address-details-actions').hide();\n	jQuery('.order-wizard-step-button-continue').removeClass('will_continueBtn');\n				\n}); </script><script> $.cookie('floodlighttrackernewuser',''); </script>  ";
