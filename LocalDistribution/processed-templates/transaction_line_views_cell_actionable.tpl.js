define('transaction_line_views_cell_actionable.tpl', ['Handlebars','Handlebars.CompilerNameLookup'], function (Handlebars, compilerNameLookup){ var template = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return " <tr id=\""
    ...
    + " <div class=\"transaction-line-views-cell-actionable-stock hide\" data-view=\"ItemViews.Stock.View\"></div><div data-view=\"StockDescription\"></div></td><td class=\"transaction-line-views-cell-actionable-table-last\"><div data-view=\"Item.Actions.View\"></div> "
